...
public class GUIInicioSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administrador de Parqueaderos");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        EmpleadosLogicaNegocio logica = new EmpleadosLogicaNegocio();
        int id = Integer.parseInt(Utilidades.extraerId(cboEmpleados.getSelectedItem().toString()));
        boolean esValido = logica.esEmpleadoValido(id, txtContrasenia.getText());
        if (esValido) {
